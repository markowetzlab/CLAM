...
class Generic_WSI_Classification_Dataset(Dataset):
	...
	def get_split_from_df(self, all_splits, split_key='train'):
		...
		if split_key not in all_splits.columns:
			print(f"The specified split_key '{split_key}' does not exist in all_splits DataFrame.")
			return None
		...
		if len(split) > 0:
			...
			print("No entries found for the given split_key after dropna.")
			split = None
	...
	def return_splits(self, from_id=True, split_csv_path=None):
